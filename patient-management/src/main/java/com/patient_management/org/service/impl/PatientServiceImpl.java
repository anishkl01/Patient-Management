...
public class PatientServiceImpl implements PatientService {
	...
	public PatientReponseDTO updatePatients(UUID id, PatientRequestDTO patientRequestDTO) {
		...
		Patient patient = patientRepository.findById(id)
				.orElseThrow(() -> new PatientNotFound("Patient not found for this Id " + id));
	...
	@Override
	public PatientReponseDTO getPatient(UUID id) {

		Patient patient = patientRepository.findById(id)
				.orElseThrow(() -> new PatientNotFound("Patient not found for this id: " + id.toString()));
